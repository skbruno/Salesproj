...
namespace SalesMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob", "bob@gmail.com", new DateTime(1998, 6, 24), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria", "maria@gmail.com", new DateTime(1979, 3, 22), 3100.0, d2);
            Seller s3 = new Seller(3, "Alex", "alex@gmail.com", new DateTime(1992, 5, 25), 2000.0, d3);
            Seller s4 = new Seller(4, "Martha", "martha@gmail.com", new DateTime(1991, 11, 01), 5200.0, d1);
            Seller s5 = new Seller(5, "Donald", "donald@gmail.com", new DateTime(1999, 1, 06), 3000.0, d2);
            Seller s6 = new Seller(6, "Junior", "junior@gmail.com", new DateTime(1996, 12, 15), 2000.0, d4);
